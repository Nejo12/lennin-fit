  ...
  return (
    <section className={s.hero}>
      <div className={s.colText}>
        ...
        <p>Stop juggling 5 tools. Lennin gives freelancers tasks, clients, and invoices in one place — so you work smart and stress less.</p>
        <div className={s.actions}>
          <a href="#start" className={s.btnPrimary}>Start Free</a>
          <a href="#features" className={s.btnGhost}>See how it fits</a>
        </div>
      ...
      <div className={s.colVisual} aria-hidden="true">
        <div className={s.cardGrid}>
          <div className={s.card}>
            ...
            <ul>
              <li>Send invoice — <strong>Acme</strong></li>
              <li>Design review — <strong>Tue 14:00</strong></li>
              <li>Follow-up email — <strong>Pending</strong></li>
            </ul>
          </div>
